...
export function QueuePage() {
  ...
  return <div className="page queue-page"><div className="queue-stage">
    ...
    <div className="queue-note"><span><UiIcon name="balance" /></span><p><strong>Competição justa</strong><br />Todas as contas Alpha têm a mesma coleção competitiva.</p></div>
  </div></div>;
}
